  ...
  return (
    <>
      ...
      <TopAppBar
        ...
        helperUserId={isOwnerish && shopId ? id.userId ?? undefined : undefined}
      />
      <InstallPwaButton />
      ...
      {/* Stocky — the feature guide — now lives in the TopAppBar (owner/admin
          only), so it's mounted there via helperUserId, not here. */}
